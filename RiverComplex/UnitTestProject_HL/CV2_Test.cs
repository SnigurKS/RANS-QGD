...
namespace UnitTestProject_HL
{
    ...
    public class CV2_Test
    {
        ...
        public void TestMethod1()
        {
            ...
            // для регулярной разбивки
            CV[0] = new[] { 6, 17, 24, 25, 26, 19, 18 };
            CV[1] = new[] { 7, 9, 16, 17, 18, 11, 10 };
            CV[2] = new[] { 8, 1, 8, 9, 10, 3, 2 };
            CV[3] = new[] { 11, 19, 26, 27, 28, 21, 20 };
            CV[4] = new[] { 12, 11, 18, 19, 20, 13, 12 };
            CV[5] = new[] { 13, 3, 10, 11, 12, 5, 4 };
            CV[6] = new[] { 16, 21, 28, 29, 30, 23, 22 };
            CV[7] = new[] { 17, 13, 20, 21, 22, 15, 14 };
            CV[8] = new[] { 18, 5, 12, 13, 14, 7, 6 };
            //
            int[][] CV2 = new int[3][];
            CV2[0] = new int[] { 7, 9, 16, 17, 18, 11, 10 };
            CV2[1] = new int[] { 12, 11, 18, 19, 20, 13, 12 };
            CV2[2] = new int[] { 17, 13, 20, 21, 22, 15, 14 };
            //
            int[][] CV_WallKnots = new int[6][];
            CV_WallKnots[0] = new int[] { 6, 17, 24, 25, 26, 19, 18 };
            CV_WallKnots[1] = new[] { 8, 1, 8, 9, 10, 3, 2 };
            CV_WallKnots[2] = new int[] { 11, 19, 26, 27, 28, 21, 20 };
            CV_WallKnots[3] = new[] { 13, 3, 10, 11, 12, 5, 4 };
            CV_WallKnots[4] = new int[] { 16, 21, 28, 29, 30, 23, 22 };
            CV_WallKnots[5] = new[] { 18, 5, 12, 13, 14, 7, 6 };
            //
        ...
        public void TestMethod2()
        {
            ...
            int[][] CV2 = new int[6][];
            CV2[0] = new int[] { 7, 9, 16, 17, 18, 11, 10 };
            CV2[1] = new int[] { 8, 1, 8, 9, 10, 3, 2 };
            CV2[2] = new int[] { 12, 11, 18, 19, 20, 13, 12 };
            CV2[3] = new int[] { 13, 3, 10, 11, 12, 5, 4 };
            CV2[4] = new int[] { 17, 13, 20, 21, 22, 15, 14 };
            CV2[5] = new int[] { 18, 5, 12, 13, 14, 7, 6 };
            //
            int[][] CV_WallKnots = new int[3][];
            CV_WallKnots[0] = new int[] { 6, 17, 24, 25, 26, 19, 18 };
            CV_WallKnots[1] = new int[] { 11, 19, 26, 27, 28, 21, 20 };
            CV_WallKnots[2] = new int[] { 16, 21, 28, 29, 30, 23, 22 };
            //
            double[] CV_wallKnotsDistance = new double[] { 0.5, 0.5, 0.5 };
            //
            for (int i = 0; i < CV.Length; i++)
