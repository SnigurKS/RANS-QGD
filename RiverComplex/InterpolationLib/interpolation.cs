...
public partial class alglib
{
    ...
    *************************************************************************/
    public static void barycentricbuilddoubleerhormann(double[] x, double[] y, int n, int d, out barycentricinterpolant b)
    {
        b = new barycentricinterpolant();
        ratint.barycentricbuilddoubleerhormann(x, y, n, d, b.innerobj);
        return;
    }
...
public partial class alglib
{
    ...
    *************************************************************************/
    public static void barycentricfitdoubleerhormannwc(double[] x, double[] y, double[] w, int n, double[] xc, double[] yc, int[] dc, int k, int m, out int info, out barycentricinterpolant b, out barycentricfitreport rep)
    {
        info = 0;
        b = new barycentricinterpolant();
        rep = new barycentricfitreport();
        lsfit.barycentricfitdoubleerhormannwc(x, y, w, n, xc, yc, dc, k, m, ref info, b.innerobj, rep.innerobj);
        return;
    }
    ...
    OUTPUT PARAMETERS:
      ...
      -- ALGLIB PROJECT --
         Copyright 18.08.2009 by Bochkanov Sergey
    *************************************************************************/
    public static void barycentricfitdoubleerhormann(double[] x, double[] y, int n, int m, out int info, out barycentricinterpolant b, out barycentricfitreport rep)
    {
        info = 0;
        b = new barycentricinterpolant();
        rep = new barycentricfitreport();
        lsfit.barycentricfitdoubleerhormann(x, y, n, m, ref info, b.innerobj, rep.innerobj);
        return;
    }
        ...
        *************************************************************************/
        ...
        Note:
          ...
          -- ALGLIB PROJECT --
             Copyright 17.06.2007 by Bochkanov Sergey
        *************************************************************************/
        public static void barycentricbuilddoubleerhormann(double[] x,
            double[] y,
            int n,
            int d,
            barycentricinterpolant b)
    ...
    public class lsfit
    {
        ...
        * another  special  case  is ONE constraint on the function value (OR, but
        ...
        above is not guaranteed and may result in inconsistency.
          ...
          -- ALGLIB PROJECT --
             Copyright 18.08.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void barycentricfitdoubleerhormannwc(double[] x,
            double[] y,
            double[] w,
            int n,
            double[] xc,
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB PROJECT --
             Copyright 18.08.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void barycentricfitdoubleerhormann(double[] x,
            double[] y,
            int n,
            int m,
            ref int info,
            ...
            barycentricfitreport rep)
        {
            ...
            barycentricfitdoubleerhormannwc(x, y, w, n, xc, yc, dc, 0, m, ref info, b, rep);
        }
        ...
        *************************************************************************/
            ...
            barycentricfitreport rep)
        {
            ...
            ratint.barycentricbuilddoubleerhormann(sx, sy, m, d, b2);
            mx = 0;
            for(i=0; i<=n-1; i++)
            {
            ...
            ratint.barycentricbuilddoubleerhormann(sx, sy, m, d, b);
